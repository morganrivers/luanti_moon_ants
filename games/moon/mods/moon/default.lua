...
cratermg.materials.hills       = minetest.get_content_id("moon:regolith")
cratermg.materials.mare        = minetest.get_content_id("moon:regolith")
cratermg.materials.crater_edge = minetest.get_content_id("moon:regolith")
cratermg.materials.crater_fill = minetest.get_content_id("moon:regolith")
cratermg.materials.dust        = minetest.get_content_id("moon:regolith")
